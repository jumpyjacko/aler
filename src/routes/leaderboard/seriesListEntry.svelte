...
>
    <img
        src={coverImage}
        alt={title}
        class="rounded-sm md:rounded-xs shadow-sm shrink-0 h-24 w-18 md:h-16 md:w-12 object-cover row-span-2 md:row-span-1"
    />

    <div
        class="md:truncate wrap-break-word font-medium self-end md:self-center"
    >
        {title}
    </div>
